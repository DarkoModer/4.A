...
<style type="text/css"> .bold {font-weight: bold;} .big {font-size: 12pt; font-family: Tahoma} .normal {font-size: 9pt; font-family: Tahoma} .bsmall {font-size: 8.5pt; font-family: Tahoma} .small {font-size: 7.5pt; font-family: Tahoma} </style>
</head>
<body class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_naziv_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$narocnik_naziv_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$narocnik_naslov_1"/>
</td>
</tr>
...
<td class="normal">
<xsl:value-of select="$narocnik_posta_kraj"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_drzava"/>
</td>
</tr>
<tr>
...
<tr>
<xsl:choose>
<xsl:when test="string-length($narocnik_davcna) > 8">
<td class="normal">
<b>ID za DDV:</b>
</td>
</xsl:when>
<xsl:when test="string-length($narocnik_davcna) < 9">
<td class="normal">
<b>Davčna št.:</b>
</td>
</xsl:when>
...
<td class="normal">
<xsl:value-of select="$narocnik_davcna"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_maticna"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$BIC_narocnik"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="concat( substring($narocnik_trr,1,4), ' ', substring($narocnik_trr,5,4), ' ', substring($narocnik_trr,9,4), ' ', substring($narocnik_trr,13,4),' ', substring($narocnik_trr,17,3))"/>
</td>
</tr>
<tr>
<td/>
<td class="normal">
<xsl:value-of select="$narocnik_banka_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$narocnik_banka_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$narocnik_tel"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_fax"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_kontaktna_oseba"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$narocnik_sifra"/>
</td>
</tr>
</table>
<br/>
...
<td class="normal">
<xsl:value-of select="$prejemnik_naziv_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$prejemnik_naziv_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$prejemnik_naslov_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$prejemnik_naslov_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$prejemnik_posta_kraj"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$prejemnik_drzava"/>
</td>
</tr>
<tr>
<td colspan="2" height="5px"/>
...
<td class="normal">
<xsl:value-of select="$prejemnik_davcna"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$prejemnik_maticna"/>
</td>
</tr>
</table>
</td>
...
<td class="normal">
<xsl:value-of select="$BIC_prejemnik"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="concat( substring($prejemnik_trr,1,4), ' ', substring($prejemnik_trr,5,4), ' ', substring($prejemnik_trr,9,4), ' ', substring($prejemnik_trr,13,4),' ', substring($prejemnik_trr,17,3))"/>
</td>
</tr>
<tr>
<td/>
<td class="normal">
<xsl:value-of select="$prejemnik_banka_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$prejemnik_banka_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$prejemnik_tel"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$prejemnik_fax"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$prejemnik_kontaktna_oseba"/>
</td>
</tr>
</table>
</td>
...
<img alt="SETCCE_logo.jpg" src="http://public.setcce.si/eSlogPrirocnik/SETCCE_logo.jpg"/>
</td>
</tr>
<tr>
<td height="20px"/>
...
<td class="normal">
<xsl:value-of select="$izdajatelj_naziv_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$izdajatelj_naziv_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$izdajatelj_naslov_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$izdajatelj_naslov_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$izdajatelj_posta_kraj"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$izdajatelj_drzava"/>
</td>
</tr>
<tr>
<td colspan="2" height="5px"/>
...
<td class="normal">
<xsl:value-of select="$izdajatelj_davcna"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$izdajatelj_maticna"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$BIC_izdajatelj"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="concat( substring($izdajatelj_trr,1,4), ' ', substring($izdajatelj_trr,5,4), ' ', substring($izdajatelj_trr,9,4), ' ', substring($izdajatelj_trr,13,4),' ', substring($izdajatelj_trr,17,3))"/>
</td>
</tr>
<tr>
<td/>
<td class="normal">
<xsl:value-of select="$izdajatelj_banka_1"/>
</td>
</tr>
...
<td/>
<td class="normal">
<xsl:value-of select="$izdajatelj_banka_2"/>
</td>
</tr>
</xsl:if>
<tr>
...
<td class="normal">
<xsl:value-of select="$izdajatelj_tel"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$izdajatelj_fax"/>
</td>
</tr>
<tr>
<td class="normal">
...
<td class="normal">
<xsl:value-of select="$izdajatelj_kontaktna_oseba"/>
</td>
</tr>
</table>
</td>
...
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
<td colspan="2" class="big" style="border-bottom: 1px solid black;">
<b>
Številka računa:
<xsl:value-of select="$STEVILKA_RACUNA"/>
</b>
</td>
</tr>
<tr>
...
<td class="normal">
<xsl:value-of select="$NASLOV_RACUNA"/>
</td>
</tr>
<tr>
<td class="normal">
<b>Obdobje opr. storitve:</b>
</td>
<td class="normal">
<xsl:value-of select="concat($OPIS_OBDOBJA, ' ', $obdobje_od, ' - ', $obdobje_do)"/>
</td>
</tr>
...
<xsl:value-of select="StevilkaDokumenta"/>
z dne
<xsl:call-template name="format_date">
...
<td width="60%" class="normal">
<xsl:value-of select="$kraj_izdaje"/>
</td>
</tr>
<tr>
<td width="40%" class="normal">
...
<tr>
<td width="40%" class="normal">
<b>Stroškovno mesto:</b>
</td>
<td width="60%" class="normal">
<xsl:value-of select="$STROSKOVNO_MESTO_RACUNA"/>
</td>
</tr>
<tr>
<td width="40%" class="normal">
<b>Obrnjena davčna vrednost:</b>
</td>
<td width="60%" class="normal">
<xsl:choose>
...
<tr>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="3%">
<b>Zap. št.</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="12%">
<b>Oznaka</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="15%">
<b>Opis</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="7%">
<b>Količina</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="8%">
<b>Enota mere</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="9%">
<b>Cena</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;" width="9%">
<b>Vrednost</b>
...
<td class="normal" valign="top" style=" border-bottom: 1px solid black;" width="9%">
<b>Osnova za DDV</b>
</td>
</tr>
<tr>
...
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;"> </td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;">
<b>Obdobje dobave</b>
</td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;">
<b>Str. mesto</b>
...
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;"> </td>
<td class="normal" valign="top" style="border-right: 1px solid black; border-bottom: 1px solid black;"> </td>
<td class="normal" valign="top" style="border-bottom: 1px solid black;">
<b>Skupaj</b>
</td>
</tr>
<tr>
<td class="normal" style="border-right: 1px solid black; border-bottom: 1px solid black;"> </td>
<td colspan="5" class="normal" valign="top" style="border-bottom: 1px solid black; border-right: 1px solid black;">
<b>Referenčni dokumenti</b>
</td>
<td colspan="5" class="normal" valign="top" style="border-bottom: 1px solid black;">
<b>Subjekti</b>
</td>
</tr>
...
<td colspan="10" class="normal" style="border-bottom: 1px solid gray;">
<b>
...
<tr>
<td class="normal" valign="top">
<xsl:value-of select="$st_vrstice"/>
</td>
<td class="normal" valign="top">
...
<td class="normal" valign="top" align="right">
<xsl:value-of select="$kolicina"/>
</td>
<td class="normal" valign="top" align="center">
<xsl:value-of select="$enota_mere"/>
</td>
<td class="normal" valign="top" align="right">
...
<td class="normal" valign="top" align="right">
<xsl:value-of select="$popust_znesek"/>
</td>
<td class="normal" valign="top" align="right">
<xsl:value-of select="$stopnja_ddv"/>
</td>
<td class="normal" valign="top" align="right">
<xsl:value-of select="$ddv"/>
</td>
<td class="normal" valign="top" align="right">
<xsl:value-of select="$osnova_ddv"/>
</td>
</tr>
<tr>
<td/>
...
<td class="normal" valign="top">
<xsl:value-of select="ObdobjeDobave"/>
 
</td>
<td class="normal" valign="top" align="right">
 
<xsl:value-of select="StroskovnoMesto"/>
</td>
<td class="normal" valign="top" align="center">
<xsl:value-of select="$OPIS_ENOTE_MERE"/>
</td>
<td/>
<td/>
<td class="normal" valign="top" align="right">
<xsl:value-of select="$popust_procent"/>
</td>
<td/>
<td/>
<td class="normal" valign="top" align="right">
<xsl:value-of select="$koncna_vrednost"/>
</td>
</tr>
<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
<td width="22%" class="normal" align="right" style="border-bottom: 1px solid black;">
<b>Stopnja DDV</b>
</td>
<td width="22%" class="normal" align="right" style="border-bottom: 1px solid black;">
<b>Osnova za DDV</b>
...
<xsl:value-of select="$pddv_stopnja"/>
</td>
<td class="normal" align="right">
<xsl:value-of select="$pddv_osnova"/>
</td>
<td class="normal" align="right">
<xsl:value-of select="$pddv"/>
</td>
</tr>
</xsl:when>
<xsl:otherwise>
...
<tr>
<td class="normal">
<b>Vrednost postavk</b>
</td>
<td class="normal" align="right">
<xsl:value-of select="format-number($zneski_vrednost, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal" align="right">
<xsl:value-of select="format-number($zneski_popust, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal">
<b>
<xsl:value-of select="concat(GlobalniPopusti/OpisPopusta,'(', GlobalniPopusti/TipPopusta, ' - ', GlobalniPopusti/OdstotekPopusta, '%)')"/>
</b>
</td>
<td class="normal" align="right">
<xsl:value-of select="format-number($globalni_popusti, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
<xsl:if test="string-length($zneski_osnovaDDV) > 0">
...
<td class="normal" align="right">
<xsl:value-of select="format-number($zneski_osnovaDDV, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal" align="right">
<xsl:value-of select="format-number($neobdavceno, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<tr>
<td class="normal">
<b>Vsota zneskov DDV</b>
</td>
<td class="normal" align="right">
<xsl:value-of select="format-number($zneski_vrednostDDV, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<tr>
<td class="normal">
<b>Vsota s popusti in davki</b>
</td>
<td class="normal" align="right">
<xsl:value-of select="format-number($zneski_vrednostZDDV, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal" align="right">
<xsl:value-of select="format-number($znesek_zamudneObr, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal" align="right">
<xsl:value-of select="format-number($znesek_dobropis, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
...
<td class="normal" align="right">
<xsl:value-of select="format-number($znesek_izravnava, '###.###.##0,00', 'dec')"/>
</td>
</tr>
</xsl:if>
<tr>
<td class="normal" style="border-top: 1px solid black; border-bottom: 1px solid black;">
<b>Za plačilo</b>
</td>
<td class="normal" style="border-top: 1px solid black; border-bottom: 1px solid black;" align="right">
